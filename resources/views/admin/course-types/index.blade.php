            ...
            <div class="row g-2 align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  ...
                  <a href="{{route('admin.course-types.create')}}" class="btn btn-primary d-none d-sm-inline-block" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 270px;">
                            ...
                            <a href="{{url('admin/course-types/'.$row->id.'/edit')}}" class="btn btn-icon btn-primary btn-sm">
