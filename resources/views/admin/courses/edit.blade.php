          ...
          <form class="needs-validation" novalidate action="{{ route($route.'.update',$row) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row ">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control myeditorinstance" name="descriptions" rows="6" placeholder="Content..">
                  {{ $row->description }}
                </textarea>
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control myeditorinstance" name="directedTo" rows="6" placeholder="Content..">
                {{ $row->directedTo }}
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control myeditorinstance" name="goals" rows="6" placeholder="Content..">
                {{ $row->goals }}
