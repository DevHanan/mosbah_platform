            ...
            <table class="table card-table table-vcenter text-nowrap datatable">
              <thead>
                <tr>
                  ...
                  <th>{{ __('admin.languages.field_photo') }}</th>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="form-check form-switch md-3" style="margin:10px">
                      ...
                      <input data-id="{{$row->id}}" data-type='App\Models\Language' class="form-check-input form-control toggole-class" type="checkbox" style="float: right;" role="switch" id="flexSwitchCheckDefault" @if($row->active==1) checked="checked" @endif name="active">
                    </div>
                  </td>
