    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item  dropdown">
          <a class="nav-link dropdown-toggle @if(request()->routeIs(['admin.courses.*','admin.lectures.*','admin.levels.*','admin.tracks.*','admin.course-types.*','dmin.startsoonCourses])) show @endif" href="" href="#navbar-layout" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="true">
          ...
          <div class="dropdown-menu  @if(request()->routeIs(['admin.courses.*','admin.lectures.*','admin.levels.*','admin.tracks.*','admin.course-types.*','admin.startsoonCourses'])) show @endif">
