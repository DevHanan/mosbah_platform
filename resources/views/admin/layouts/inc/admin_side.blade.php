    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item  dropdown">
          <a class="nav-link dropdown-toggle @if(request()->routeIs(['admin.courses.*','admin.recommendCourses','admin.startsoonCourses','admin.lectures.*','admin.levels.*','admin.tracks.*','admin.course-types.*'])) show @endif" href="" href="#navbar-layout" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="true">
          ...
          <div class="dropdown-menu  @if(request()->routeIs(['admin.courses.*','admin.recommendCourses','admin.startsoonCourses','admin.lectures.*','admin.levels.*','admin.tracks.*','admin.course-types.*'])) show @endif">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle @if(request()->routeIs(['admin.subjects.*'])) show @endif " href="#navbar-layout" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-question-mark">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path d="M8 8a3.5 3 0 0 1 3.5 -3h1a3.5 3 0 0 1 3.5 3a3 3 0 0 1 -2 3a3 4 0 0 0 -2 4" />
          ...
          <div class="dropdown-menu  @if(request()->routeIs(['admin.subjects.*'])) show @endif  ">
            <div class="dropdown-menu-columns">
              <div class="dropdown-menu-column">
                <a class="dropdown-item  {{ request()->is('ar/admin/subjects?classroom=1') || request()->is('en/admin/subjects?classroom=1')? 'active' : '' }}" href="{{url('admin/subjects?classroom=1')}}">
                  {{ __('navbar.calculate_equation.first_secondary_subjects') }}
                </a>
                <a class="dropdown-item  {{ request()->is('ar/admin/subjects?classroom=2') || request()->is('en/admin/subjects?classroom=2')? 'active' : '' }}" href="{{url('admin/subjects?classroom=2')}}">
                  {{ __('navbar.calculate_equation.second_secondary_subjects') }}
                </a>
                <a class="dropdown-item {{ request()->is('ar/admin/subjects?classroom=3') ||request()->is('en/admin/subjects?classroom=3')? 'active' : '' }}" href="{{url('admin/subjects?classroom=3')}}">
