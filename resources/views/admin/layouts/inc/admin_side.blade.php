      ...
      <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu  @if(request()->routeIs(['admin.subjects.*'])) show @endif  ">
            <div class="dropdown-menu-columns">
              <div class="dropdown-menu-column">
                <a class="dropdown-item  {{ request()->is(app()->getLoclae().'/admin/subjects?classroom=1')? 'active' : '' }}" href="{{url('admin/subjects?classroom=1')}}">
                  {{ __('navbar.calculate_equation.first_secondary_subjects') }}
                </a>
                <a class="dropdown-item  {{ request()->is(app()->getLoclae().'/admin/subjects?classroom=2')? 'active' : '' }}" href="{{url('admin/subjects?classroom=2')}}">
                  {{ __('navbar.calculate_equation.second_secondary_subjects') }}
                </a>
                <a class="dropdown-item {{ request()->is(app()->getLoclae().'/admin/subjects?classroom=3')? 'active' : '' }}" href="{{url('admin/subjects?classroom=3')}}">
