      ...
      <ul class="navbar-nav pt-lg-3">
        ...
        <li class="nav-item ">
          <a class="nav-link " href="#">
            ...
            <span class="nav-link-title">
              {{ __('navbar.students.studentTestResult') }}
            </span>
          </a>
        </li>
        <li class="nav-item ">
          <a class="nav-link " href="#">
            ...
            <span class="nav-link-title">
              {{ __('navbar.students.courses_payment') }}
            </span>
          </a>
        </li>
        <li class="nav-item ">
          <a class="nav-link " href="#">
            ...
            <span class="nav-link-title">
              {{ __('navbar.students.certificationfromin') }}
            </span>
          </a>
        </li>
        <li class="nav-item ">
          <a class="nav-link " href="#">
            ...
            <span class="nav-link-title">
              {{ __('navbar.students.certificationfromout') }}
            </span>
          </a>
        </li>
