...
<div class="page-header d-print-none">
  <div class="container-xl">
    <div class="row g-2 align-items-center">
      <div class="col">
        {{ Breadcrumbs::render('quiz-questions',$quiz) }}
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="width: 270px;">
                    ...
                    <a href="{{ route($route.'.edit',[$quiz->id,$row->id]) }}" class="btn btn-icon btn-primary btn-sm">
                    ...
                    @include('admin.layouts.inc.custom-quiz-question-delete')
