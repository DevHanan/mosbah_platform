    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="">{{trans('admin/main.dashboard')}}</a>
                </div>
        ...
        <div class="section-body">
            ...
            <section class="card">
                <div class="card-body">
                    <form action="#" method="get" class="row mb-0">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="webinar_ids[]" multiple="multiple" class="form-control search-webinar-select2"
                                        data-placeholder="{{trans('admin/main.search_courses')}}">
                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($quizzes as $quiz)
                                        <tr>
                                            ...
                                            <td>
                                                <span>{{ $quiz->title }}</span>
                                                @if(!empty($quiz->teacher))
                                                    <small class="d-block text-left text-primary">{{ $quiz->teacher->full_name ?? ''}}</small>
                                                @endif
                                            </td>
