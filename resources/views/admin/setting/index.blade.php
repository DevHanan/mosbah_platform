                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="mb-3">
                            ...
                            <img style="height:200px" src="{{ asset($row->loginImageFullPath) }}" class="img-fluid setting-image" alt="{{ __('field_site_favicon') }}">
                            <div class="clearfix"></div>
                            @endif
                          </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="mb-3">
                            ...
                            <img style="height:200px" src="{{ asset($row->registerImageFullPath) }}" class="img-fluid setting-image" alt="{{ __('field_site_favicon') }}">
                            <div class="clearfix"></div>
                            @endif
                          </div>
