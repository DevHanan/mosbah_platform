        ...
        <div class="header text-white">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <img src="{{ asset('public/front/img/image 44.png')}}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
              <div class="col-md-5 mb-4">
                  <div class="position-relative w-100 h-100 gallery-item">
                      <img src="{{ asset('public/front/img/Rectangle 1585.png')}}" class="w-100 h-100" alt="">
              ...
              <div class="col-md-7 mb-4">
                  <div class="position-relative w-100 h-100 gallery-item">
                      <img src="{{ asset('public/front/img/Rectangle 1586.png')}}" class="w-100 h-100" alt="">
                  </div>
              </div>
              <div class="col-md-8 mb-4">
                  <div class="position-relative w-100 h-100 gallery-item">
                      <img src="{{ asset('public/front/img/Rectangle 1588.png')}}" class="w-100 h-100" alt="">
                      <div class="position-absolute play-icon p-3 rounded-pill d-flex justify-content-center align-items-center">
              ...
              <div class="col-md-4 mb-4">
                  <div class="position-relative w-100 h-100 gallery-item">
                      <img src="{{ asset('public/front/img/Rectangle 1587.png')}}" class="w-100 h-100" alt="">
                  </div>
              </div>
            </div>
          </section>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card shadow-sm border mb-5 mx-3">
                    <a href="{{ url('blog/1') }}" class="position-relative">
                        <img class="card-img-top" src="{{ asset('public/front/img/image 46.png')}}" alt="Card image cap">
                    </a>
                    <div class="card-body">
