        ...
        <section class="news-titles titles d-flex justify-content-between p-5" style="direction: rtl;">
            <div class="mb-2" style="direction: rtl;">
              ...
              <div class="d-flex align-items-center filter-by-date">
                ...
                <a href="{{url('/blogs')}}" class="btn border p-2 px-4 mx-2 mb-2 reset_btn">تحميل</a>
                </div>
              </form>
            </div>
          </section>
                  ...
                  <div class="col-lg-4 col-md-6 card_pagination">
                    <div class="card shadow-sm mb-5 mx-3">
                        <a href="{{url('/blog/'.$blog->id)}}" class="position-relative">
                            @if($blog->main_image)
                            <img class="card-img-top w-100 p-2" src="{{ asset($blog->imageFullPath)}}" style="height: 250px;" alt="Card image cap">
                            @else
                            <img class="card-img-top w-100 p-2" src="{{asset('front/img/Book.svg')}}" style="height: 250px;" alt="Card image cap">
                            @endif
                        </a>
                        <div class="card-body">
                            ...
                            <div class="cardFooter d-flex justify-content-between align-items-center">
                                <div class="card-date primary-color fw-bold">{{ $blog->CustomPublishdate }}  </div>
