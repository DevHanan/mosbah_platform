                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 paginationCardData">
                                            <div class="card__data p-3 pt-1">
                                                <a href="pages/{{url('/course')}}" class="text-decoration-none text-dark">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <a href="{{url('/course')}}" class="link-arrow rounded-circle"><i class="fa-solid fa-arrow-up-long"></i></a>
                                                    <div class="price">
                ...
                <div class="container">
                    ...
                    <div class="card__content">
                        ...
                        <div class="card__data p-3">
                            ...
                            <hr>
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{url('/course')}}" class="link-arrow secondary-bg rounded-circle"><i class="fa-solid fa-arrow-up-long"></i></a>
                                <div class="price">
