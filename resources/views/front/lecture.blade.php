                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="course_content shadow-sm border my-4 p-2" style="border-radius: 24px;">
                                <div class="info mt-3 px-4">
                                    <p> <img src="../img/icons/fi-rr-e-learning.png" class="ms-2" width="20" alt=""> <span> {{ optional($lecture->course)->name }} </span></p>
                                    <p> <img src="../img/icons/fi-rr-e-learning.png" class="ms-2" width="20" alt=""> <span> {{ optional($lecture->level)->name }} </span></p>
                                    ...
                                    <p> <img src="../img/icons/fi-rr-e-learning.png" class="ms-2" width="20" alt=""> <span> نوع المحاضرة :
                                            @if($lecture->type == 1)
