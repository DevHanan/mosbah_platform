...
<head>
  ...
  @endif
  {{ $setting->title }}</title>
  <link rel="shortcut icon" href="{{ asset($setting->iconFullPath) }}">    <link rel="stylesheet" href="{{asset('{{asset('{{asset('public/front/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"/>
    <link rel="stylesheet" href="{{asset('{{asset('{{asset('public/front/css/swiper-bundle.min.css')}}">
    <link rel="stylesheet" href="{{asset('{{asset('{{asset('public/front/css/custom.css')}}">
    <link rel="stylesheet" href="{{asset('{{asset('{{asset('public/front/css/media.css')}}">
        ...
        <div class="welcome w-100 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="data text-center text-white">
                <div class="img mb-4 position-relative">
                    ...
                    <img src="{{asset('{{asset('{{asset('public/front/img/sign-completed.svg')}}" class="img-fluid" alt="">
                </div>
